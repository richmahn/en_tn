...
Some translations set each line of poetry further to the right than the rest of the text to make it easier to read. The ULB does this with the poetry in 7:6-7, which is quoted from the OT.
