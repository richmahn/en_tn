...
Some translations set each line of poetry farher to the right than the rest of the text to make it easier to read. The ULB does this with the poetry in 15:9-11, 21. All of these lines are quoted from the OT.

Some translations set prose quotations from the Old Testament farher to the right on the page than the rest of the text. The ULB does this with the quoted material in 15:12.
