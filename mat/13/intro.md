...
Some translations set each line of poetry farher to the right than the rest of the text to make it easier to read. The ULB does this with the poetry in 13:14-15, which is quoted from the OT.
