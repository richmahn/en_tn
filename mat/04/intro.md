...
Some translations set each line of poetry farher to the right than the rest of the text to make it easier to read. The ULB does this with the poetry in verses 6, 15 and 16, which is quoted from the OT.

Some translations set quotations from the Old Testament farher to the right on the page than the rest of the text. The ULB does this with the quoted material in verse 10.
