...
Some translations set each line of poetry farther to the right than the rest of the text to make it easier to read. The ULB does this with the poetry in verses 6, 15 and 16, which are words from the Old Testament.
